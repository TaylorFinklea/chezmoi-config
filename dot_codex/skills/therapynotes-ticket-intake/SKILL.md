---
name: therapynotes-ticket-intake
...
If the user explicitly wants the downstream GitHub Copilot rollout after an `ISD` AI model request already exists, hand off to `/Users/tfinklea/.codex/skills/therapynotes-grc-ai-model-workflow/SKILL.md`.
