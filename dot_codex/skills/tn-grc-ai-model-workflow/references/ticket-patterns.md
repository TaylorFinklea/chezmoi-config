...
Observed and updated through 2026-03-09 while drafting `tn-grc-ai-model-workflow`.
...
- After each IT ticket has its screenshot, sprint, and story points, follow:
  - `../tn-it-change-workflow/SKILL.md`
  - `../tn-it-change-workflow/references/jira-field-map.md`
