---
name: therapynotes-grc-ai-adoption-workflow
...
# TherapyNotes GRC AI Adoption Workflow
...
Read `/Users/tfinklea/.codex/skills/therapynotes-it-change-workflow/SKILL.md` and `/Users/tfinklea/.codex/skills/therapynotes-it-change-workflow/references/jira-field-map.md` before moving any IT ticket into planning or creating the change ticket.

If the request is specifically an AI model approval that should become a GitHub Copilot model-enable ticket, use `/Users/tfinklea/.codex/skills/therapynotes-grc-ai-model-workflow/SKILL.md` instead.
...
- After the IT ticket is drafted and the sprint and story points are known, follow `/Users/tfinklea/.codex/skills/therapynotes-it-change-workflow/SKILL.md`.
