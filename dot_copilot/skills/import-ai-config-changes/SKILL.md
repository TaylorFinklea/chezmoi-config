...
- Only run `./scripts/sync-ai-configs.sh` when the review report shows safe additions only or the user explicitly approves importing just that safe subset via GitHub Copilot CLI.
